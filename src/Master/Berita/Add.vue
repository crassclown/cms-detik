                    ...
                    <div class="card-body">
                        ...
                        <form class="">
                            <div class="position-relative form-group"><label for="exampleEmail"
                                    ...
                                    placeholder="with a placeholder" type="email" class="form-control">
                            </div>
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form class=""><input placeholder="lg" type="text"
                                class="mb-2 form-control-lg form-control"><input placeholder="default" type="text"
                                class="mb-2 form-control"><input placeholder="sm" type="text"
